...
## 11 — State policy liberalism (Caughey–Warshaw 2016)  (Day 1)

- **Field:** American state politics
- **Method:** OLS → lasso / ridge / elastic net + ABESS best subset; repeated held-out (n = 50)
- **Data file:** [`state_policy_liberalism.csv`](https://raw.githubusercontent.com/desmarais-lab/desmarais-lab.github.io/master/istanbul_bilgi_ml_files/data/state_policy_liberalism.csv)
- **Notebook:** [`notebooks/11_state_policy_liberalism_day1.ipynb`](notebooks/11_state_policy_liberalism_day1.ipynb)
- **Published study:** Caughey, D. & Warshaw, C. (2016). "The Dynamics of State Policy Liberalism, 1936–2014." *American Journal of Political Science* 60(4):899–913 — cross-sectional model of state **policy liberalism** on public opinion and state conditions. Data: Correlates of State Policy Project (Jordan & Grossmann 2020). Illustrates **regularization improving out-of-sample prediction** in a small-n design.
